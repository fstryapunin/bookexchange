...
-- Started on 2022-03-27 22:46:03
...
-- Name: update_edited_column(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_edited_column() OWNER TO postgres;
...
-- Name: listing_tags; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.listing_tags OWNER TO postgres;

--
-- TOC entry 208 (class 1259 OID 57450)
-- Name: lisiting_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.lisiting_tags_id_seq OWNER TO postgres;

--
-- TOC entry 2909 (class 0 OID 0)
-- Dependencies: 208
-- Name: lisiting_tags_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: listing_tags id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
-- Name: listing_tags lisiting_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: listings update_listing_edited; Type: TRIGGER; Schema: public; Owner: postgres
--
...
-- Completed on 2022-03-27 22:46:04
