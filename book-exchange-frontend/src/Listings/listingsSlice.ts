...
export const fetchListings = createAsyncThunk<Listing[], number>('listings/get', async (page = 0) => {
...
export const fetchFilteredListings = createAsyncThunk<Listing[], any>('listings/filter', async (filters) => {    
...
export const fetchListingById = createAsyncThunk<Listing, number | string>('listings/get/id', async (id) => {
